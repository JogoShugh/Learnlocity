...
(function() {
  var FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, FacebookStrategy, app, express, http, io, passport, server, service, _;
  ...
  io.sockets.on('connection', function(socket) {
    var join, notifyAllClients, notifyRoom, notifySourceClient, sourceClientId;
    ...
    service.NotifyRoomChannels = function(room, topic, data, includeSelf, mixInPropertiesMap) {
    ...
    return socket.on('message', function(data) {
      ...
      return service.processMessage(commandClassName, commandConstructorArguments);
    });
  });
