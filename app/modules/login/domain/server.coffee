...
io.sockets.on 'connection', (socket) ->
    ...
    service.NotifyAllClients = notifyAllClients
    service.NotifySourceClient = notifySourceClient
    service.Join = join
    service.NotifyRoom = notifyRoom
    service.NotifyRoomChannels = (room, topic, data, includeSelf=false, mixInPropertiesMap=null) ->        
    ...
    socket.on 'message', (data) ->    
        ...
        service.processMessage commandClassName, commandConstructorArguments